...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">测试日志信息</h3>
            </div>
        </div>
                    ...
                    <table id="table_log"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="createTime" data-sortable="true">运行时间</th>
                                <th data-field="suiteName" data-sortable="true">所属用例集名</th>
                                <th data-field="methodName" data-sortable="true">所属用例名</th>
                                <th data-field="description" data-sortable="true">步骤描述</th>
                                <th data-field="actual" data-sortable="true">实际结果</th>
                                <th data-field="expected" data-sortable="true">期望结果</th>
                                <th data-field="isPass" data-sortable="true">步骤通过情况</th>
                            </tr>
                        </thead>
                    </table>
                </div>
...
<script src="../resources/js/plugins/dataTables/bootstrap-table-export.js"></script>
...
<script>
    ...
    function getAllRow() {
        var value = $table.bootstrapTable('getData');
        return value;
    }
</script>
-->
