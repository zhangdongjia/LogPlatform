...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">测试用例报告</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    ...
                    <table id="table_method"
                           data-url="/report/getAllMethod"
                           data-toggle="table"
                           data-search="true"
                        ...
                        <tr>
                            ...
                            <th data-field="methodName" data-sortable="true">用例名</th>
                            <th data-field="processPass" data-sortable="true">该用例通过步骤数</th>
                            <th data-field="processFail" data-sortable="true">该用例未通过步骤数</th>
                            <th data-field="methodResult" data-sortable="true">用例通过情况</th>
                        </tr>
                        </thead>
                    </table>
                </div>
