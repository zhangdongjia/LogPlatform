...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">测试用例集报告</h3>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="table-responsive">
                    ...
                    <table id="table_suite"
                           data-url="/report/getAllSuite"
                           data-toggle="table"
                           data-search="true"
                        ...
                        <tr>
                            ...
                            <th data-field="suiteName" data-sortable="true">用例集名</th>
                            <th data-field="methodsPass" data-sortable="true">该用例集通过用例数</th>
                            <th data-field="methodsFail" data-sortable="true">该用例集未通过用例数</th>
                            <th data-field="suiteResult" data-sortable="true">用例集通过情况</th>
                        </tr>
                        </thead>
                    </table>
                </div>
